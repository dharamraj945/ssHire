...
include './admin_config/logout.php';
...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | DevDesire</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="assets/images/logo/logo-sm.png">
    ...
    <div id="layout-wrapper">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="/assets/images/logo/main_logo.png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="/assets/images/logo/main_logo.png" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                <div data-simplebar style="max-height: 320px;">
                                    ...
                                    <div class="dropdown-item bg-transparent text-wrap">
                                        <a href="index" class="btn btn-soft-secondary btn-sm rounded-pill">how to
                                            setup <i class="mdi mdi-magnify ms-1"></i></a>
                                        <a href="index" class="btn btn-soft-secondary btn-sm rounded-pill">buttons
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $_SESSION['user_name']; ?>
                                        </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form action="" method="post">
                                    <button class="dropdown-item" name="logout"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></button>
                                </form>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="./assets/images/logo/logo-sm-white.png" alt="" height=" 22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="index" class="logo logo-light">
                    <span class="logo-sm">
                        <img style="width:auto; height:45px;" src="./assets/images/logo/logo-sm-white.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img style="width:auto; height:45px;" src="./assets/images/logo/logo-white.png" alt="" height="17">
                    </span>
                </a>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="newjob_post" class="nav-link" data-key="t-addjob"> Post New Job
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="all-jobs-post" class="nav-link" data-key="t-All Jobs"> All Jobs </a>
                                    </li>
                                    <!-- <li class="nav-item">
